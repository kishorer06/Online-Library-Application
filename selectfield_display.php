...
<p><a class="search" href="book.php">Home</a></p>
<center>
...
@ $db = new mysqli("localhost","root","","ols");
  ...
  $query = "select * from book_register WHERE category='$_POST[srchtype]'";
  ...
  <?php $i=1;
	...
	<td><?php echo $i++ ; ?></td>
	 ...
	 <td><a href="book_register/<?php echo $row['file'] ?>" target="_blank"> View </a></td>
	 </tr>
	 <?php
   } 
	$result->free();
